								...
								<v-row>
									<v-col>
										...
										<v-btn class="add-button text-none rounded" color="primary" :ripple="false"
											prepend-icon="mdi-database-outline" text="Logs"></v-btn>
									</v-col>
								</v-row>

								<!-- Building Logs -->
								<PaneBuildingLog :loading="apiLoading" :logs="buildingLogs"
									@update-logs="fetchBuildingLogs"></PaneBuildingLog>
							</v-col>
						</v-row>
					</div>
...
import PaneBuildingLog from './PaneBuildingLog.vue';
